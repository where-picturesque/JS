...
//				var time = data.time;
//				console.log(time)
//				var exp = /\d/g.exec(time)
//				var day=time.substr(exp.index,2);
//				console.log(exp)
//				$(".pro-time-inner .day").html(day)
//				
//				var time=time.substring(exp.index+1)
//				console.log(time);
//				var exp=/\d/g.exec(time);
//				var hour=time.substr(exp.index,2);
//				console.log(exp)
//				$(".pro-time-inner .hours").html(hour);
